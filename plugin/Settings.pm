...
my @xmldevice = qw(name mac stream_length accept_nexturi buffer_dir buffer_limit sample_rate codecs L24_format flac_header enabled send_metadata volume_on_play max_volume match_endianness raw_audio_format send_coverart seek_after_pause byte_seek send_icy volume_feedback stream_pacing_size server min_gapless);
