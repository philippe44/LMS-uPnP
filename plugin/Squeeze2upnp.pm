...
sub binaries {
	...
	if ($os->{'os'} eq 'Linux') {
		...
		return qw(squeeze2upnp-x86-64 squeeze2upnp-x86 squeeze2upnp-x86-static squeeze2upnp-armv6hf squeeze2upnp-armv6hf-static squeeze2upnp-armv5 squeeze2upnp-armv5-static);
	}
