...
Packaged versions can found [here](https://sourceforge.net/projects/lms-plugins-philippe44/files) and support thread is [there](http://forums.slimdevices.com/showthread.php?103728-Announce-UPnPBridge-integrate-UPnP-DLNA-players-with-LMS-(squeeze2upnp)&p=820082&viewfull=1#post820082)
