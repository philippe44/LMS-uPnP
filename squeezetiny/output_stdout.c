...
/*---------------------------------------------------------------------------*/
void output_init_mr(log_level level, unsigned output_buf_size, char *params, unsigned rates[], unsigned rate_delay) {
	loglevel = level;

	LOG_INFO("init output media render", NULL);
	...
	output.write_cb = &_mr_write_frames;
...
/*---------------------------------------------------------------------------*/
void output_mr_close(void) {
	LOG_INFO("close media renderer", NULL);
